...
import static es.apachecsv.org.apache.commons.csv.Constants.BACKSLASH;
import static es.apachecsv.org.apache.commons.csv.Constants.COMMA;
import static es.apachecsv.org.apache.commons.csv.Constants.COMMENT;
import static es.apachecsv.org.apache.commons.csv.Constants.CR;
import static es.apachecsv.org.apache.commons.csv.Constants.CRLF;
import static es.apachecsv.org.apache.commons.csv.Constants.DOUBLE_QUOTE_CHAR;
import static es.apachecsv.org.apache.commons.csv.Constants.LF;
import static es.apachecsv.org.apache.commons.csv.Constants.PIPE;
import static es.apachecsv.org.apache.commons.csv.Constants.SP;
import static es.apachecsv.org.apache.commons.csv.Constants.TAB;
 ...
 *
 * <p>
 * The {@link es.apachecsv.org.apache.commons.csv.CSVParser} provides static methods to parse other input types, for example:
 * </p>
 *
 * <pre>
 ...
 *
 * <p>
 * Calling {@link #withHeader(String...)} let's you use the given names to address values in a {@link es.apachecsv.org.apache.commons.csv.CSVRecord}, and
 ...
 *
 * <p>
 * For other input types, like resources, files, and URLs, use the static methods on {@link es.apachecsv.org.apache.commons.csv.CSVParser}.
 * </p>
 *
 ...
 *
 * Then, call one of the {@link es.apachecsv.org.apache.commons.csv.CSVRecord} get method that takes a String column name argument:
 * </p>
 *
 * <pre>
...
public final class CSVFormat implements Serializable {
    ...
    private final es.apachecsv.org.apache.commons.csv.QuoteMode quoteMode;
     ...
     *             if the delimiter is a line break character
     */
    private CSVFormat(final char delimiter, final Character quoteChar, final es.apachecsv.org.apache.commons.csv.QuoteMode quoteMode,
    ...
    public String format(final Object... values) {
        ...
        try {
            new es.apachecsv.org.apache.commons.csv.CSVPrinter(out, this).printRecord(values);
     ...
     */
    public es.apachecsv.org.apache.commons.csv.QuoteMode getQuoteMode() {
        return quoteMode;
    }
     ...
     *
     * <p>
     * See also the various static parse methods on {@link es.apachecsv.org.apache.commons.csv.CSVParser}.
     * </p>
     *
     * @param in
     *            the input stream
     ...
     */
    public es.apachecsv.org.apache.commons.csv.CSVParser parse(final Reader in) throws IOException {
     ...
     *
     * <p>
     * See also {@link es.apachecsv.org.apache.commons.csv.CSVPrinter}.
     * </p>
     *
     * @param out
     *            the output
     ...
     */
    public es.apachecsv.org.apache.commons.csv.CSVPrinter print(final Appendable out) throws IOException {
        return new es.apachecsv.org.apache.commons.csv.CSVPrinter(out, this);
    }
    ...
    public void print(final Object value, final Appendable out, final boolean newRecord) throws IOException {
        ...
        if (value == null) {
            charSequence = nullString == null ? es.apachecsv.org.apache.commons.csv.Constants.EMPTY : nullString;
        } else {
    ...
    private void printAndQuote(final Object object, final CharSequence value, final int offset, final int len,
        ...
        es.apachecsv.org.apache.commons.csv.QuoteMode quoteModePolicy = getQuoteMode();
        if (quoteModePolicy == null) {
            quoteModePolicy = es.apachecsv.org.apache.commons.csv.QuoteMode.MINIMAL;
        }
    ...
    private void validate() throws IllegalArgumentException {
        ...
        if (escapeCharacter == null && quoteMode == es.apachecsv.org.apache.commons.csv.QuoteMode.NONE) {
     ...
     * </pre>
     * <p>
     * The header is also used by the {@link es.apachecsv.org.apache.commons.csv.CSVPrinter}.
     * </p>
     *
     * @param headerEnum
